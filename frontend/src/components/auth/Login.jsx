...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
  <div className="hidden md:flex flex-col items-center justify-center bg-gray-50 rounded-xl p-6 text-center">
    <img src="/logo (1).png" alt="Logo" className="w-16 h-16 rounded-lg ring-2 ring-blue-200 mb-4" />
    <h3 className="text-xl font-semibold text-gray-900">AI Keyword Generator</h3>
    <p className="text-gray-600 mt-2">Powered by multiple AI models for content creators</p>
